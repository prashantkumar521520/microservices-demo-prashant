...
public class EmployeeController {
    ...
    public Employee add(@RequestBody Employee employee) {
        LOGGER.info("Employee add: {}", keyValue("employee", employee));
    ...
    public List<Employee> findByDepartment(@PathVariable("departmentId") String departmentId) {
        LOGGER.info("Employee find: departmentId={}", keyValue("path", "/department/{departmentId}"));
        return repository.findByDepartmentId(departmentId);
    }

    @GetMapping("/organization/{organizationId}")
    public List<Employee> findByOrganization(@PathVariable("organizationId") String organizationId) {
        LOGGER.info("Employee find: organizationId={}", keyValue("path", "/organization/{organizationId}"));
